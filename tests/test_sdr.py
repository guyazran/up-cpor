...
SIMULATOR_CONFIG = {
    ...
    # The first obj-at observation is stable; later replanning still hits the
    # known SDR observation-format bug for this domain.
    "colorballs2-2": {"max_steps": 1, "stop_on_goal": False},
